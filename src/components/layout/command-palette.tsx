...
const NAVIGATION: CommandItem[] = [
  ...
  { id: "n4", label: "Órdenes de Trabajo", icon: <ClipboardList className="h-4 w-4" />, href: "/orders" },
  { id: "n5", label: "Ingeniería", icon: <Wrench className="h-4 w-4" />, href: "/engineering" },
  { id: "n6", label: "Números de Parte", icon: <Settings className="h-4 w-4" />, href: "/production" },
