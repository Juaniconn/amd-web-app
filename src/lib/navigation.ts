...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/customers", label: "Clientes", enabled: false, phase: "Fase 2" },
  { href: "/quotes", label: "Cotizaciones", enabled: false, phase: "Fase 3" },
  { href: "/orders", label: "Pedidos", enabled: false, phase: "Fase 4" },
  { href: "/production", label: "Producción", enabled: false, phase: "Fase 5" },
  ...
  { href: "/machines", label: "Máquinas", enabled: false, phase: "Fase 5" },
