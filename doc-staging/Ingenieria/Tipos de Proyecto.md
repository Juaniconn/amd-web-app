...
Puede nacer de una RFQ nueva o de un plano ya liberado (cambio de ingeniería). Proceso de versiones: ⬜ pendiente.
...
Horas de ingeniería suelen ser altas; deben poder costearse aparte. Tarifa: ⬜ pendiente.
...
El cliente **sí** trae plano (escenario B). Ingeniería no diseña de cero: confirma que AMD puede fabricarlo (centros, tolerancias, material).
