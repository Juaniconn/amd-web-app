...
Entrada de ingeniería: [[Proceso Ingenieria]]. En escenario A la OP espera plano `Liberado` (ADR-031).
...
No hay `production:*` ni los cinco permisos operativos (Autorizar Producción, Liberar Material, Programar Máquinas, Liberar Calidad, Cerrar Orden). El rol Producción solo tiene `dashboard:read`. Ver ADR-029.
...
ADR-025, ADR-026, ADR-027, ADR-028, ADR-029, ADR-030.
