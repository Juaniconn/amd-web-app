...
Fuente de diseño: BUSINESS_SPEC §§15–18 y 41, ADR-025, ADR-026 (numeración reemplazada), **ADR-030**, **ADR-031**, **ADR-035**.  
...
- Operador
- Fecha prometida de piso (**criterio 1 de prioridad**, ADR-030)
...
```
Producción → Calidad → Liberación → Entrega
```

Principal: Inspector de Calidad. Alternativa: Supervisor de Producción.
...
- Los planos viven en documentos de la **cotización**, no de la OP.
...
**No hay código.** El diseño técnico de Fase 5 debe implementar estas reglas de piso, no reabrirlas. El diseño técnico de Fase 4 (Ingeniería) decide el gate del plano.
