...
**Fase 4 — Ingeniería y Diseño está ✅ implementada.**  
...
Producción (documentación de piso ya validada, ADR-030) es **Fase 5** y **no se implementa todavía**.
...
Pedidos UI sigue diferida. El pedido mínimo (ADR-023) no cambia. Origen: ADR-035.
...
Ver [[AMD_OPERATIONS_BUSINESS_SPEC]], [[Proceso Ingenieria]], [[Ingenieria Executive Summary]], [[Proceso Producción]], ADR-031, ADR-032, ADR-033, ADR-034, ADR-035.
